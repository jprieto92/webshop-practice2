			...
			<div class="col-lg-8 col-lg-offset-2">
				...
				<form name="sentMessage" action="ControllerAdminServlet" id="contactForm" enctype="multipart/form-data" novalidate method="post">
					<div class="row control-group">
							...
							value="" id="nombreCategoria"name="nombreCategoria" 
								required
					...
					<div class="row control-group">
							...
							required data-validation-required-message="Por favor, introduzca una descripccion de categoria."></textarea>
							
							<p class="help-block text-danger"></p>
						
					</div>
					<input type="hidden" name="pAccion" value=nuevaCategoriaAdmin>
					<br>
					<div id="success"></div>
					<div class="row">
						<div class="form-group col-xs-12">
							<button type="submit" class="btn btn-success btn-lg">Insertar</button>
						</div>
					</div>
				</form>
			</div>
