...
//	 *  */
	...
	@RequestMapping(value="/productos/{productId}", method = RequestMethod.GET)
	public Usuario usuarioPorIdProducto(@PathVariable("productId") Integer productId){
		System.out.println("Busca usuario por id");
		Usuario usuario = usuarioRepository.findByProductoProductId(productId);
		System.out.println(usuario);
	...
	public Usuario crear(@RequestBody Usuario usuarioCrear){
		System.out.println("He recibido la peticion");
		Usuario usuario = new Usuario(usuarioCrear.getEmail(), usuarioCrear.getNombre(), usuarioCrear.getApellido1(), usuarioCrear.getApellido2(), usuarioCrear.getCiudad(), usuarioCrear.getTelefono(), usuarioCrear.getFechaAlta(),usuarioCrear.getContraseña(),usuarioCrear.getImagenPerfil(), null);
		...
		System.out.println(usuario2.getImagenPerfil());
		return usuario2;
	}
	
	@RequestMapping(value="/login", method = RequestMethod.POST)
	public Usuario login(@RequestBody Usuario usuarioCrear){
